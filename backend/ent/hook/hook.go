...
// The DeliveryAgencyFunc type is an adapter to allow the use of ordinary
// function as DeliveryAgency mutator.
type DeliveryAgencyFunc func(context.Context, *ent.DeliveryAgencyMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DeliveryAgencyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DeliveryAgencyMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DeliveryAgencyMutation", m)
}
