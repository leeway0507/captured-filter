...
export default function SearchInputMain() {
  ...
  return (
    <div className="flex flex-grow items-center max-w-[600px] h-[60px] border rounded-full shadow-lg relative mx-4">
      ...
      />
      <button type="button" className="right-1 absolute flex-center rounded-full bg-rose-600 text-white h-[70%] aspect-square mx-2" onClick={onClickHandler} aria-label="Search">
