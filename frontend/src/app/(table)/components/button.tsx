...
export function LeftArrowButton({ ...rest }:ButtonElement) {
  return (
    <div
      {...rest}
      className={cn('rounded-full bg-rose-600 text-white flex flex-center w-7 h-7 z-[21]', rest.className)}
...
export function RightArrowButton({ ...rest }:ButtonElement) {
  return (
    <div
      {...rest}
      className={cn('rounded-full border bg-rose-600 text-white flex flex-center w-7 h-7 z-[21]', rest.className)}
