...
import DataTablePagination from '@/app/(table)/components/pagination';
  ...
  return (
    <div className="overflow-auto lg:overflow-clip mx-auto relative max-w-[1024px] w-full pt-[10px]">
      <div className="w-full rt-tbody">
        ...
        {table.getRowModel().rows?.length === 0 && <div className="text-2xl w-full h-full flex-center py-8">필터 결과가 없습니다.</div>}
      </div>
