...
import { SelecFilterDialog, YesOrNoFilterDialog, DefaultSelectProps } from '@/app/(table)/components/filter-component';
import { QuestionToolTip } from '@/app/(table)/components/utils';
import { StoreTableProps } from './data-preprocessor';

export function FreeDeliveryFeeMin({ column, columnName }:
{ column: Column<StoreTableProps, any>, columnName:string }) {
...
export function TaxReduction({ column, columnName }:
{ column: Column<StoreTableProps, any>, columnName:string }) {
...
export function DeliveryFeeCumulation({ column, columnName }:
{ column: Column<StoreTableProps, any>, columnName:string }) {
...
export function Country({ column, columnName }:
{ column: Column<StoreTableProps, any>, columnName:string }) {
